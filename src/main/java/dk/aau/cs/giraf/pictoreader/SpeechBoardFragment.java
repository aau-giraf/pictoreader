...
public class SpeechBoardFragment extends Fragment implements ShowcaseManager.ShowcaseCapable {
    ...
    public static final String HERE_YOU_REMOVE_PICTOGRAMS =
        "Her fjerner du piktogrammer der er tilføjet til sætnings kassen";
    List<dk.aau.cs.giraf.dblib.models.Pictogram> selectedPictograms =
        new ArrayList<dk.aau.cs.giraf.dblib.models.Pictogram>();
    ...
    public static List<dk.aau.cs.giraf.dblib.models.Pictogram> speechboardPictograms =
        new ArrayList<dk.aau.cs.giraf.dblib.models.Pictogram>();
    //This category contains the pictograms on the sentenceboard
    public static ArrayList<dk.aau.cs.giraf.dblib.models.Pictogram> sentencePictogramList =
        new ArrayList<dk.aau.cs.giraf.dblib.models.Pictogram>();
    ...
    public SpeechBoardFragment(Context context) {
    ...
    private void setupEverything() {
        View view = LayoutInflater.from(parent.getApplicationContext()).inflate(R.layout.speechboard_layout, null);
    ...
    private void setupCategoryGrid() {
        if (!isGuardianMode()) {
            ...
            categoryGrid.setAdapter(new PARROTCategoryAdapter(user.getCategories(),
                parent, R.id.category, user, displayedMainCategoryIndex));
        }
    }
    ...
    private void setupSentenceBoard() {
        ...
        if (isGuardianMode()) {
            trashButtonWidth = (int) GirafScalingUtilities.convertDpToPixel(parent.getApplicationContext(),
                getResources().getDimension(R.dimen.buttonPlayWidth));
            ...
            trashButtonWidth = (int) GirafScalingUtilities.convertDpToPixel(parent.getApplicationContext(),
                getResources().getDimension(R.dimen.buttonTrashWidth));
        }

        int playButtonWidth = (int) GirafScalingUtilities.convertDpToPixel(parent.getApplicationContext(),
            getResources().getDimension(R.dimen.buttonPlayWidth));
        ...
        RelativeLayout.LayoutParams sbParams = new RelativeLayout.LayoutParams(getScreenSize() - playButtonWidth -
            trashButtonWidth, (int) GirafScalingUtilities.convertDpToPixel(parent, 150));
    ...
    private void setupButtons() {
        ...
        if (isGuardianMode()) {
            RelativeLayout.LayoutParams sbParams = new RelativeLayout.LayoutParams((int)
                GirafScalingUtilities.convertDpToPixel(parent, 100),
                (int) GirafScalingUtilities.convertDpToPixel(parent, 150));
    ...
    public void setGridviewColNumb() {
        ...
        int trashButtonWidth = (int) GirafScalingUtilities.convertDpToPixel(parent.getApplicationContext(),
            getResources().getDimension(R.dimen.buttonTrashWidth));
    ...
    public void callPictosearch() {
        ...
        try {
            ...
            if (intent.getExtras().getLong("currentChildID", -1) != -1) {
                intent.putExtra(getString(R.string.current_child_id), intent.getExtras().getLong(
                    "currentChildID", -1));
            } else {
                intent.putExtra(getString(R.string.current_child_id), (long) -1);
            }

            intent.putExtra(getString(R.string.current_guardian_id), intent.getExtras().getLong(
                "currentGuardianID", -1));
    ...
    public void showShowcase() {
        ...
        // Create a relative location for the next button
        final RelativeLayout.LayoutParams rightButtonParams = new RelativeLayout.LayoutParams(
        ...
        // Create a relative location for the next button
        final RelativeLayout.LayoutParams centerRightButtonParams = new RelativeLayout.LayoutParams(
            ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        ...
        if (isGuardianMode()) {
            //Search Button
            final ViewTarget searchButtonTarget = new ViewTarget(
                getActivity().getActionBar().getCustomView().findViewById(R.id.search_button), 1.5f);
        ...
        final ViewTarget helpButtonTarget = new ViewTarget(
            getActivity().getActionBar().getCustomView().findViewById(R.id.help_button), 1.5f);
        showcaseManager.addShowCase(new ShowcaseManager.Showcase() {
            @Override
            public void configShowCaseView(final ShowcaseView showcaseView) {
