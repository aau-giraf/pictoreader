 ...
 * By convention, your test case name should also follow the same name as the Java or Android class that you want to
 * test, but suffixed with “Test”. Names of test methods must start with the word 'test'.
 */
